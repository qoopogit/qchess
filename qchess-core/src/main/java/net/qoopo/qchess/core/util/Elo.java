...
/**
 * A utility class for calculating Elo score differences based on match
 * statistics such as the win ratio or the numbers of wins, losses, and draws.
 *
 * @author Viktor
 */
public final class Elo {
    ...
    /**
     * The minimum allowed win ratio. Any win ratio smaller than this defaults
     * to this value.
     */
    private static final double MIN_WIN_RATIO = 1e-5;
    /**
     * The maximum allowed win ratio. Any win ratio greater than this defaults
     * to this value.
     */
    ...
    /**
     * Calculates the Elo rating difference between a player and its opponent
     * based on the match record against this opponent.
     *
     ...
     */
    public static int calculateDifference(int wins, int losses, int draws) {
    ...
    /**
     * Calculates the Elo rating difference between a player and its opponent
     * based on the win ratio against this opponent.
     *
     * @param winRatio The win ratio. It has to between 0 and 1.
     * @return The Elo rating difference.
     */
    public static int calculateDifference(double winRatio) {
    ...
    public static void main(String[] args) {
        System.out.println("ELO=" + calculateDifference(4000, 3000, 500));
    }
}
